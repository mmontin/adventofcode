...
public class Launcher {
  ...
  public static class Entry {
    ...
    public Entry(final String s) {
      ...
      final String[] split1 = split.getLast().split("\\[");
    ...
    public boolean verifyChecksum() {
      ...
      {
        final Function2<ArrayList<String>, String, ArrayList<String>> _function = (ArrayList<String> l, String v) -> {
          ArrayList<String> _xblockexpression_1 = null;
          {
            final Function1<Character, String> _function_1 = (Character it) -> {
              return (it + "");
            };
            l.addAll(ListExtensions.<Character, String>map(((List<Character>)Conversions.doWrapArray(v.toCharArray())), _function_1));
        ...
        final Function2<ArrayList<Launcher.Tuple>, String, ArrayList<Launcher.Tuple>> _function_1 = (ArrayList<Launcher.Tuple> l, String e) -> {
          ArrayList<Launcher.Tuple> _xblockexpression_1 = null;
          {
        ...
        final Function1<Launcher.Tuple, String> _function_2 = (Launcher.Tuple it) -> {
          return it.s;
        };
    ...
    public String decode() {
      final Function1<String, String> _function = (String it) -> {
        final Function2<String, Character, String> _function_1 = (String s, Character v) -> {
          int _indexOf = Launcher.Entry.alphabet.indexOf((v).charValue());
          int _plus = (_indexOf + (this.sector_id).intValue());
          int _modulo = (_plus % 26);
          char _charAt = Launcher.Entry.alphabet.charAt(_modulo);
          return (s + Character.valueOf(_charAt));
        };
        return IterableExtensions.<Character, String>fold(((Iterable<Character>)Conversions.doWrapArray(it.toCharArray())), "", _function_1);
      };
  ...
  public static void main(final String[] args) {
    final Function1<String, Launcher.Entry> _function = (String it) -> {
    ...
    final Function2<Integer, Launcher.Entry, Integer> _function_1 = (Integer sum, Launcher.Entry e) -> {
    ...
    final Function1<Launcher.Entry, Boolean> _function_2 = (Launcher.Entry it) -> {
      return Boolean.valueOf(it.verifyChecksum());
    };
    final Function1<Launcher.Entry, Boolean> _function_3 = (Launcher.Entry it) -> {
