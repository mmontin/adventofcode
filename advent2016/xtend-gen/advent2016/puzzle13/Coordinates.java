...
public class Coordinates {
  ...
  public Coordinates(final int x_, final int y_) {
    ...
    final Function2<Integer, Character, Integer> _function = (Integer v, Character c) -> {
  ...
  public void step(final Set<Coordinates> visited, final Set<Coordinates> toVisit) {
    ...
    final Function1<Coordinates, Boolean> _function = (Coordinates it) -> {
      return Boolean.valueOf((((it.passable && (it.x >= 0)) && (it.y >= 0)) && (!visited.contains(it))));
    };
    final Consumer<Coordinates> _function_1 = (Coordinates s) -> {
      final Function1<Coordinates, Boolean> _function_2 = (Coordinates it) -> {
        return Boolean.valueOf(it.equals(s));
      };
      Coordinates c = IterableExtensions.<Coordinates>findFirst(toVisit, _function_2);
      if ((c == null)) {
        c = s;
        toVisit.add(c);
      }
      c.updateDistance((this.distance + 1));
    };
