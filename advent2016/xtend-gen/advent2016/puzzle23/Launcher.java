...
public class Launcher {
  public static List<Instruction> instructions = new ArrayList<Instruction>(new InputLoader(Integer.valueOf(2016), Integer.valueOf(23)).<Instruction>getInputs(new Function1<String, Instruction>() {
    public Instruction apply(final String it) {
