...
public class Day20 {
  public static class Tile {
    ...
    public String getBorder(final Direction d) {
      ...
      if (d != null) {
        switch (d) {
          case UP:
            final Function2<String, Integer, String> _function = (String acc, Integer i) -> {
            ...
            break;
          case DOWN:
            final Function2<String, Integer, String> _function_1 = (String acc, Integer i) -> {
              String _xifexpression = null;
            ...
            break;
          case LEFT:
            final Function2<String, Integer, String> _function_2 = (String acc, Integer i) -> {
              String _xifexpression = null;
            ...
            break;
          case RIGHT:
            final Function2<String, Integer, String> _function_3 = (String acc, Integer i) -> {
              String _xifexpression = null;
    ...
    public static List<Day20.Tile> allVariants(final long _number, final Set<Coordinate> input, final int _size) {
      List<Day20.Tile> _xblockexpression = null;
      {
        ...
        final Function1<HashSet<Coordinate>, Day20.Tile> _function_1 = (HashSet<Coordinate> it) -> {
  ...
  public static void main(final String[] args) {
    ...
    final Function2<ArrayList<Day20.Tile>, Integer, ArrayList<Day20.Tile>> _function = (ArrayList<Day20.Tile> acc, Integer i) -> {
      ArrayList<Day20.Tile> _xblockexpression = null;
      {
        ...
        final List<List<String>> current = ListExtensions.<String, List<String>>map(input.subList((((i).intValue() * 12) + 1), (((i).intValue() * 12) + 11)), _function_1);
    ...
    final Function1<Day20.Tile, Boolean> _function_1 = (Day20.Tile it) -> {
      boolean _xblockexpression = false;
      {
        ...
        final Function1<Day20.Tile, Boolean> _function_2 = (Day20.Tile it_1) -> {
          return Boolean.valueOf(it_1.matchesSomewhereWithOtherName(rb, name));
        };
        final Day20.Tile rmatch = IterableExtensions.<Day20.Tile>findFirst(dup, _function_2);
        final Function1<Day20.Tile, Boolean> _function_3 = (Day20.Tile it_1) -> {
          return Boolean.valueOf(it_1.matchesSomewhereWithOtherName(db, name));
        };
        final Day20.Tile dmatch = IterableExtensions.<Day20.Tile>findFirst(dup, _function_3);
        final Function1<Day20.Tile, Boolean> _function_4 = (Day20.Tile it_1) -> {
          return Boolean.valueOf(it_1.matchesSomewhereWithOtherName(ub, name));
        };
        final Day20.Tile umatch = IterableExtensions.<Day20.Tile>findFirst(dup, _function_4);
        final Function1<Day20.Tile, Boolean> _function_5 = (Day20.Tile it_1) -> {
          return Boolean.valueOf(it_1.matchesSomewhereWithOtherName(lb, name));
        };
        final Day20.Tile lmatch = IterableExtensions.<Day20.Tile>findFirst(dup, _function_5);
    ...
    final Predicate<Day20.Tile> _function_2 = (Day20.Tile it) -> {
    ...
    for (final Integer j : _upTo) {
      {
        final Function1<Day20.Tile, Boolean> _function_3 = (Day20.Tile it) -> {
        ...
        final Predicate<Day20.Tile> _function_4 = (Day20.Tile it) -> {
    ...
    for (final Integer i : _upTo_1) {
      {
        ...
        for (final Integer j_1 : _upTo_2) {
          {
            final Function1<Day20.Tile, Boolean> _function_5 = (Day20.Tile it) -> {
              return Boolean.valueOf(it.matchesThereButWithOtherName(Day20.current_tile.getBorder(Direction.RIGHT), Direction.LEFT, 
                Day20.current_tile.number));
            };
            ...
            final Predicate<Day20.Tile> _function_6 = (Day20.Tile it) -> {
              return (it.number == Day20.current_tile.number);
            };
    ...
    final Consumer<Day20.Tile> _function_3 = (Day20.Tile it) -> {
      it.trim();
    };
    image.values().forEach(_function_3);
    final Function2<HashSet<Coordinate>, Map.Entry<Coordinate, Day20.Tile>, HashSet<Coordinate>> _function_4 = (HashSet<Coordinate> acc, Map.Entry<Coordinate, Day20.Tile> v) -> {
      HashSet<Coordinate> _xblockexpression = null;
      {
        ...
        v.getValue().content.forEach(_function_5);
        _xblockexpression = acc;
      }
      return _xblockexpression;
    };
    ...
    final Function1<Day20.Tile, Boolean> _function_5 = (Day20.Tile im) -> {
      final Function1<Integer, Boolean> _function_6 = (Integer i_1) -> {
        final Function1<Integer, Boolean> _function_7 = (Integer j_1) -> {
          final Function1<Coordinate, Coordinate> _function_8 = (Coordinate it) -> {
            int _x = it.getX();
            int _plus_1 = (_x + (i_1).intValue());
            int _y = it.getY();
            int _plus_2 = (_y + (j_1).intValue());
            return new Coordinate(_plus_1, _plus_2);
          };
          return Boolean.valueOf(im.content.containsAll(IterableExtensions.<Coordinate>toSet(IterableExtensions.<Coordinate, Coordinate>map(sea_monster, _function_8))));
        };
        Integer _findFirst = IterableExtensions.<Integer>findFirst(new IntegerRange(0, (full_size - monster_width)), _function_7);
        return Boolean.valueOf((_findFirst != null));
      };
      Integer _findFirst = IterableExtensions.<Integer>findFirst(new IntegerRange(0, (full_size - monster_depth)), _function_6);
      return Boolean.valueOf((_findFirst != null));
    };
    ...
    for (final Integer i_1 : _upTo_2) {
      ...
      for (final Integer j_1 : _upTo_3) {
        {
          final Function1<Coordinate, Coordinate> _function_6 = (Coordinate it) -> {
            int _x = it.getX();
            int _plus_1 = (_x + (i_1).intValue());
            int _y = it.getY();
            int _plus_2 = (_y + (j_1).intValue());
