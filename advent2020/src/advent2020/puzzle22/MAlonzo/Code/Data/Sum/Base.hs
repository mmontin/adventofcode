...
du94
  = coe
      du66 (coe du92 (coe C38)) (\ v0 -> coe C42 (coe C42 (coe v0)))
name96 = "Data.Sum.Base.assocˡ"
d96 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
  MAlonzo.Code.Agda.Primitive.T4 ->
...
du96
  = coe
      du66 (\ v0 -> coe C38 (coe C38 (coe v0))) (coe du88 (coe C42))
name98 = "Data.Sum.Base._-⊎-_"
d98 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
  MAlonzo.Code.Agda.Primitive.T4 ->
...
d98 = erased
name104 = "Data.Sum.Base.fromDec"
d104 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  () -> MAlonzo.Code.Relation.Nullary.T32 -> T30
d104 v0 v1 v2 = du104 v2
du104 :: MAlonzo.Code.Relation.Nullary.T32 -> T30
du104 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
name110 = "Data.Sum.Base.toDec"
d110 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  () -> T30 -> MAlonzo.Code.Relation.Nullary.T32
d110 v0 v1 v2 = du110 v2
du110 :: T30 -> MAlonzo.Code.Relation.Nullary.T32
du110 v0
  = case coe v0 of
      C38 v1
        -> coe
