...
d478 ::
  ...
  MAlonzo.Code.Relation.Binary.Structures.T270
...
du478 v0
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C10525
      (coe
         du438 (coe MAlonzo.Code.Relation.Binary.Structures.d172 (coe v0)))
      (coe MAlonzo.Code.Relation.Binary.Structures.d174 (coe v0))
      (coe
         du428 (coe MAlonzo.Code.Relation.Binary.Structures.d174 (coe v0))
         (coe MAlonzo.Code.Relation.Binary.Structures.d176 (coe v0)))
name530
...
d530 v0 v1 v2 v3 v4 v5 v6 v7 = du530 v6 v7
du530 ::
  (AgdaAny -> AgdaAny -> MAlonzo.Code.Relation.Nullary.T32) ->
  MAlonzo.Code.Relation.Binary.Structures.T340 ->
  MAlonzo.Code.Relation.Binary.Structures.T454
...
d576 ::
  ...
  MAlonzo.Code.Relation.Binary.Structures.T454
d576 v0 v1 v2 v3 v4 v5 v6 = du576 v6
du576 ::
  MAlonzo.Code.Relation.Binary.Structures.T388 ->
  MAlonzo.Code.Relation.Binary.Structures.T454
du576 v0
  = coe
      du530 (coe MAlonzo.Code.Relation.Binary.Structures.d400 (coe v0))
      (coe MAlonzo.Code.Relation.Binary.Structures.d398 (coe v0))
name634 = "Relation.Binary.Construct.NonStrictToStrict.irrefl"
d634 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T14 -> MAlonzo.Code.Data.Empty.T4
d634 = erased
name636 = "Relation.Binary.Construct.NonStrictToStrict.trans"
d636 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
...
d638 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T14 -> MAlonzo.Code.Data.Empty.T4
d638 = erased
name640 = "Relation.Binary.Construct.NonStrictToStrict.decidable"
d640 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Agda.Primitive.T4 ->
...
du642 ::
  ...
  (AgdaAny -> AgdaAny -> MAlonzo.Code.Data.Sum.Base.T30) ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Relation.Binary.Definitions.T136
du642 v0 v1 v2 v3 v4 v5 = coe du346 v1 v3 v4 v5
name644
