...
public class Day8 {
  ...
  public static void main(final String[] args) {
    ...
    final Function1<String, Pair<ArrayList<Pair<String, Integer>>, Pair<String, Integer>>> _function_3 = new Function1<String, Pair<ArrayList<Pair<String, Integer>>, Pair<String, Integer>>>() {
      public Pair<ArrayList<Pair<String, Integer>>, Pair<String, Integer>> apply(final String it) {
    ...
    final Function1<Pair<ArrayList<Pair<String, Integer>>, Pair<String, Integer>>, Integer> _function_4 = new Function1<Pair<ArrayList<Pair<String, Integer>>, Pair<String, Integer>>, Integer>() {
      public Integer apply(final Pair<ArrayList<Pair<String, Integer>>, Pair<String, Integer>> it) {
    ...
    final Function2<Long, Integer, Long> _function_5 = new Function2<Long, Integer, Long>() {
      public Long apply(final Long acc, final Integer el) {
