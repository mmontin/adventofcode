...
public class Day20 {
  ...
  public static void main(final String[] args) {
    ...
    final Consumer<Map.Entry<String, advent2023.Module>> _function_3 = (Map.Entry<String, advent2023.Module> it) -> {
      final List<String> targets = it.getValue().targets;
      final Function1<String, advent2023.Module> _function_4 = (String it_1) -> {
        return Day20.modules.get(it_1);
      };
      final Consumer<advent2023.Module> _function_5 = (advent2023.Module tar) -> {
        if ((tar instanceof Conjunction)) {
          ((Conjunction) tar).addSource(it.getKey());
        }
      };
      ListExtensions.<String, advent2023.Module>map(targets, _function_4).forEach(_function_5);
    };
    ...
    final Function2<Long, Long, Long> _function_4 = (Long x, Long y) -> {
  ...
  public static void pushButton() {
    final Consumer<Pair<Boolean, String>> _function = (Pair<Boolean, String> it) -> {
  ...
  public static boolean processMessage(final Pair<String, Pair<Boolean, String>> message) {
    boolean _xblockexpression = false;
    {
      ...
      final Function1<Pair<Boolean, String>, Pair<String, Pair<Boolean, String>>> _function = (Pair<Boolean, String> it) -> {
