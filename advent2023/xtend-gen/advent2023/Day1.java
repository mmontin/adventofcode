...
public class Day1 {
  ...
  private static final Set<Pair<String, String>> srebmun = IterableExtensions.<Pair<String, String>>toSet(IterableExtensions.<Pair<String, String>, Pair<String, String>>map(Day1.numbers, ((Function1<Pair<String, String>, Pair<String, String>>) (Pair<String, String> x) -> {
  ...
  public static void main(final String[] args) {
    ...
    final Function2<Pair<Integer, Integer>, String, Pair<Integer, Integer>> _function = (Pair<Integer, Integer> e, String v) -> {
      ...
      while ((res == null)) {
        {
          ...
          final Function1<Pair<String, String>, Boolean> _function = (Pair<String, String> x) -> {
