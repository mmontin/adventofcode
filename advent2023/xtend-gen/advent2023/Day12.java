...
public class Day12 {
  public static void main(final String[] args) {
    final Function1<String, Pair<String, List<Integer>>> _function = new Function1<String, Pair<String, List<Integer>>>() {
      public Pair<String, List<Integer>> apply(final String it) {
        Pair<String, List<Integer>> _xblockexpression = null;
        {
          ...
          List<Integer> _map = ListExtensions.<String, Integer>map(((List<String>)Conversions.doWrapArray((split[1]).split(","))), _function);
    ...
    final Function2<Long, Pair<String, List<Integer>>, Long> _function_1 = new Function2<Long, Pair<String, List<Integer>>, Long>() {
      public Long apply(final Long acc, final Pair<String, List<Integer>> el) {
    ...
    final Function1<Pair<String, List<Integer>>, Pair<String, ArrayList<Integer>>> _function_2 = new Function1<Pair<String, List<Integer>>, Pair<String, ArrayList<Integer>>>() {
      public Pair<String, ArrayList<Integer>> apply(final Pair<String, List<Integer>> el) {
        Pair<String, ArrayList<Integer>> _xblockexpression = null;
        {
          ...
          new IntegerRange(0, 4).forEach(_function);
    ...
    final Function2<Long, Pair<String, ArrayList<Integer>>, Long> _function_3 = new Function2<Long, Pair<String, ArrayList<Integer>>, Long>() {
      public Long apply(final Long acc, final Pair<String, ArrayList<Integer>> el) {
        Long _call = Day12.myRunner.call(el.getKey(), el.getValue());
        return Long.valueOf(((acc).longValue() + (_call).longValue()));
      }
    };
  ...
  private static final RunnerWithMemory2<String, List<Integer>, Long> myRunner = new RunnerWithMemory2<String, List<Integer>, Long>(new Function2<String, List<Integer>, Long>() {
    public Long apply(final String x, final List<Integer> y) {
  ...
  public static Long count(final String line, final List<Integer> brokens) {
    ...
    if (!_matched) {
      Long _xblockexpression = null;
      {
        ...
        final Function2<Long, Pair<Pair<String, String>, String>, Long> _function = new Function2<Long, Pair<Pair<String, String>, String>, Long>() {
          public Long apply(final Long acc, final Pair<Pair<String, String>, String> el) {
            long _xblockexpression = (long) 0;
            {
              ...
              _xblockexpression = ((acc).longValue() + (right_possibilities * left_possibilities));
            }
