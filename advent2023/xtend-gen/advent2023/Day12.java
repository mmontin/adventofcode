...
public class Day12 {
  ...
  private static final MemoryRunner2<String, List<Integer>, Long> myRunner = new MemoryRunner2<String, List<Integer>, Long>(((Function2<String, List<Integer>, Long>) (String x, List<Integer> y) -> {
