...
public class Day3 {
  ...
  public static void main(final String[] args) {
    ...
    final Function1<Map.Entry<Coordinate, List<Integer>>, Boolean> _function_1 = (Map.Entry<Coordinate, List<Integer>> x) -> {
      int _size = x.getValue().size();
      return Boolean.valueOf((_size == 2));
    };
    final Function2<Integer, Map.Entry<Coordinate, List<Integer>>, Integer> _function_2 = (Integer acc, Map.Entry<Coordinate, List<Integer>> v) -> {
