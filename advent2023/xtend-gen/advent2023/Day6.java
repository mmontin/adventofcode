...
public class Day6 {
  ...
  public static void main(final String[] args) {
    final Function2<Integer, Pair<Long, Long>, Integer> _function = (Integer acc, Pair<Long, Long> el) -> {
      int _xblockexpression = (int) 0;
      {
        ...
        int _size = IterableExtensions.size(IterableExtensions.<Long>filter(nb, _function_1));
    ...
    final Function2<Integer, Pair<Long, Long>, Integer> _function_1 = (Integer acc, Pair<Long, Long> el) -> {
      int _xblockexpression = (int) 0;
      {
        final ArrayList<Long> nb = Day6.possibilities((el.getKey()).longValue());
        final Function1<Long, Boolean> _function_2 = (Long it) -> {
          Long _value = el.getValue();
          return Boolean.valueOf((it.compareTo(_value) > 0));
        };
        int _size = IterableExtensions.size(IterableExtensions.<Long>filter(nb, _function_2));
        _xblockexpression = ((acc).intValue() * _size);
      }
      return Integer.valueOf(_xblockexpression);
    };
  ...
  public static ArrayList<Long> possibilities(final long time) {
    final Function2<ArrayList<Long>, Integer, ArrayList<Long>> _function = (ArrayList<Long> acc, Integer el) -> {
