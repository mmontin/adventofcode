...
public class Day1 {
  public static void main(final String[] args) {
    ...
    final Function2<Pair<Integer, Integer>, String, Pair<Integer, Integer>> _function = (Pair<Integer, Integer> acc, String s) -> {
    ...
    final Function2<Pair<Integer, ArrayList<Integer>>, String, Pair<Integer, ArrayList<Integer>>> _function_1 = (Pair<Integer, ArrayList<Integer>> acc, String s) -> {
