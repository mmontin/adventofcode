...
public class Day18 {
  private static final Set<Triplet> elements = new HashSet<Triplet>(
    ListExtensions.<String, Triplet>map(new InputLoader(Integer.valueOf(2022), Integer.valueOf(18)).getInputs(), new Function1<String, Triplet>() {
  ...
  public static void main(final String[] args) {
    ...
    final Function2<Pair<Integer, Integer>, Triplet, Pair<Integer, Integer>> _function = new Function2<Pair<Integer, Integer>, Triplet, Pair<Integer, Integer>>() {
      public Pair<Integer, Integer> apply(final Pair<Integer, Integer> acc, final Triplet triplet) {
        Pair<Integer, Integer> _xblockexpression = null;
        {
          ...
          int _size = IterableExtensions.size(IterableExtensions.<Triplet>reject(current_neighbours, _function));
          ...
          int _size_1 = IterableExtensions.size(IterableExtensions.<Triplet>filter(current_neighbours, _function_1));
