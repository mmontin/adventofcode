...
public class Day10 {
  public static void main(final String[] args) {
    ...
    final Function2<Integer, Integer, Integer> _function_2 = (Integer acc, Integer v) -> {
    ...
    final Consumer<Integer> _function_3 = (Integer i) -> {
      ...
      final Consumer<Integer> _function_4 = (Integer j) -> {
        ...
        if (((Objects.equals(j, reg) || ((j).intValue() == ((reg).intValue() - 1))) || ((j).intValue() == ((reg).intValue() + 1)))) {
          screen.get((i).intValue()).add("#");
        } else {
          screen.get((i).intValue()).add(".");
        }
      };
      new IntegerRange(0, 39).forEach(_function_4);
    };
    new IntegerRange(0, 5).forEach(_function_3);
    final Consumer<ArrayList<String>> _function_4 = (ArrayList<String> line) -> {
      final Consumer<String> _function_5 = (String chara) -> {
        InputOutput.<String>print(chara);
      };
      line.forEach(_function_5);
      InputOutput.println();
    };
