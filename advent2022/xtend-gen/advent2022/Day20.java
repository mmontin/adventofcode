...
public class Day20 {
  ...
  private static final List<Long> raw_inputs = ListExtensions.<String, Long>map(new InputLoader(Integer.valueOf(2022), Integer.valueOf(20)).getInputs(), ((Function1<String, Long>) (String it) -> {
  ...
  public static void main(final String[] args) {
    ...
    final Function1<Day20.MyLong, Day20.MyLong> _function = (Day20.MyLong it) -> {
  ...
  public static void oneRound(final List<Day20.MyLong> _current) {
    final Consumer<Day20.MyLong> _function = (Day20.MyLong it) -> {
  ...
  public static Long printResult(final List<Day20.MyLong> _current) {
    ...
    {
      final Function1<Day20.MyLong, Boolean> _function = (Day20.MyLong it) -> {
