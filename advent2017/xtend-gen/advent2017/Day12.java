...
public class Day12 {
  public static void main(final String[] args) {
    ...
    final Consumer<String> _function = (String it) -> {
      ...
      currentSet.addAll(ListExtensions.<String, Integer>map(((List<String>)Conversions.doWrapArray((split[1]).split(", "))), _function_1));
      sets.add(currentSet);
    };
    ...
    while ((sets.size() != 0)) {
      {
        ...
        final Function1<HashSet<Integer>, Boolean> _function_1 = (HashSet<Integer> s) -> {
          final Function1<Integer, Boolean> _function_2 = (Integer it) -> {
            return Boolean.valueOf(current.contains(it));
          };
          Integer _findFirst = IterableExtensions.<Integer>findFirst(s, _function_2);
    ...
    final Function1<HashSet<Integer>, Boolean> _function_1 = (HashSet<Integer> it) -> {
