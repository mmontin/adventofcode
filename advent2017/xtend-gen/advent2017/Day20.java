...
public class Day20 {
  ...
  public static void main(final String[] args) {
    ...
    final Function1<String, Day20.Particle> _function_1 = (String it) -> {
    ...
    for (final Integer i : _upTo) {
      {
        final Consumer<Day20.Particle> _function_2 = (Day20.Particle it) -> {
          it.update();
        };
        particles.forEach(_function_2);
        final Function1<Day20.Particle, Triplet> _function_3 = (Day20.Particle it) -> {
          return it.position;
        };
        final Function1<List<Day20.Particle>, Boolean> _function_4 = (List<Day20.Particle> it) -> {
          int _size = it.size();
          return Boolean.valueOf((_size == 1));
        };
        final Function2<List<Day20.Particle>, List<Day20.Particle>, List<Day20.Particle>> _function_5 = (List<Day20.Particle> p, List<Day20.Particle> q) -> {
