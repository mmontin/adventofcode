...
public class Day2 {
  public static void main(final String[] args) {
    ...
    final Function2<Pair<Integer, Integer>, String, Pair<Integer, Integer>> _function = (Pair<Integer, Integer> acc1, String e1) -> {
      Pair<Integer, Integer> _xblockexpression = null;
      {
        final Function1<String, Integer> _function_1 = (String it) -> {
          return Integer.valueOf(Integer.parseInt(it));
        };
        final List<Integer> s = ListExtensions.<String, Integer>map(((List<String>)Conversions.doWrapArray(e1.split("\\s+"))), _function_1);
        Pair<Integer, Integer> _mappedTo_1 = Pair.<Integer, Integer>of(Integer.valueOf(0), Integer.valueOf(Integer.MAX_VALUE));
        final Function2<Pair<Integer, Integer>, Integer, Pair<Integer, Integer>> _function_2 = (Pair<Integer, Integer> acc2, Integer e2) -> {
          Pair<Integer, Integer> _xblockexpression_1 = null;
          {
            ...
            _xblockexpression_1 = Pair.<Integer, Integer>of(new_max, new_min);
          }
          return _xblockexpression_1;
        };
        final Pair<Integer, Integer> res1 = IterableExtensions.<Integer, Pair<Integer, Integer>>fold(s, _mappedTo_1, _function_2);
