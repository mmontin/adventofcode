...
public class Day3 {
  public static void main(final String[] args) {
    ...
    final Function1<String, Pair<Coordinate.Direction, Integer>> _function = (String it) -> {
      Coordinate.Direction _directionFromString = Coordinate.directionFromString(it.substring(0, 1));
      int _parseInt = Integer.parseInt(it.substring(1));
      return Pair.<Coordinate.Direction, Integer>of(_directionFromString, Integer.valueOf(_parseInt));
    };
    final List<Pair<Coordinate.Direction, Integer>> path1 = ListExtensions.<String, Pair<Coordinate.Direction, Integer>>map(((List<String>)Conversions.doWrapArray(inputs.get(0).split(","))), _function);
    final Function1<String, Pair<Coordinate.Direction, Integer>> _function_1 = (String it) -> {
      Coordinate.Direction _directionFromString = Coordinate.directionFromString(it.substring(0, 1));
      int _parseInt = Integer.parseInt(it.substring(1));
      return Pair.<Coordinate.Direction, Integer>of(_directionFromString, Integer.valueOf(_parseInt));
    };
    final List<Pair<Coordinate.Direction, Integer>> path2 = ListExtensions.<String, Pair<Coordinate.Direction, Integer>>map(((List<String>)Conversions.doWrapArray(inputs.get(1).split(","))), _function_1);
  ...
  public static HashMap<Coordinate, Integer> navigate(final List<Pair<Coordinate.Direction, Integer>> path) {
    HashMap<Coordinate, Integer> _xblockexpression = null;
    {
      ...
      for (final Pair<Coordinate.Direction, Integer> line : path) {
