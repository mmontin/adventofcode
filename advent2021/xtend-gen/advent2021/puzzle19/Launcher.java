...
public class Launcher {
  public static void main(final String[] args) {
    try {
      ...
      final Function2<ArrayList<HashMap<Integer, Coordinate>>, List<Vector>, ArrayList<HashMap<Integer, Coordinate>>> _function = (ArrayList<HashMap<Integer, Coordinate>> l, List<Vector> vectors) -> {
      ...
      final Function2<HashMap<Integer, HashSet<Integer>>, Integer, HashMap<Integer, HashSet<Integer>>> _function_1 = (HashMap<Integer, HashSet<Integer>> m, Integer i) -> {
        int _size_1 = data_distances.size();
        final Function2<HashMap<Integer, HashSet<Integer>>, Integer, HashMap<Integer, HashSet<Integer>>> _function_2 = (HashMap<Integer, HashSet<Integer>> m2, Integer j) -> {
          HashMap<Integer, HashSet<Integer>> _xblockexpression = null;
          {
            ...
            if (((newm.size() >= 66) && (!Objects.equals(i, j)))) {
              final BiFunction<HashSet<Integer>, HashSet<Integer>, HashSet<Integer>> _function_3 = (HashSet<Integer> r, HashSet<Integer> s) -> {
              ...
              m2.merge(i, CollectionLiterals.<Integer>newHashSet(j), _function_3);
            }
            _xblockexpression = m2;
          }
          return _xblockexpression;
        };
        return IterableExtensions.<Integer, HashMap<Integer, HashSet<Integer>>>fold(new ExclusiveRange(0, _size_1, true), m, _function_2);
      };
      ...
      while ((!adjacency.isEmpty())) {
        {
          final Function1<Map.Entry<Integer, HashSet<Integer>>, Boolean> _function_2 = (Map.Entry<Integer, HashSet<Integer>> it) -> {
          ...
          final Integer pivot = IterableExtensions.<Integer>toList(entry.getValue()).getLast();
      ...
      final Function2<HashSet<Vector>, List<Vector>, HashSet<Vector>> _function_2 = (HashSet<Vector> set, List<Vector> vectors) -> {
  ...
  public static Vector collapse(final List<Vector> vectors1, final HashMap<Integer, Coordinate> dists1, final List<Vector> vectors2, final Map<Integer, Coordinate> dists2) {
    Vector _xblockexpression = null;
    {
      ...
      final Consumer<Map.Entry<Integer, Coordinate>> _function = (Map.Entry<Integer, Coordinate> it) -> {
        final Coordinate coord1 = it.getValue();
        final Coordinate coord2 = dists2.get(it.getKey());
        int _x = coord2.getX();
        int _y = coord2.getY();
        final BiFunction<Set<Integer>, Set<Integer>, Set<Integer>> _function_1 = (Set<Integer> s1, Set<Integer> s2) -> {
          HashSet<Integer> _xblockexpression_1 = null;
          {
            final HashSet<Integer> s3 = new HashSet<Integer>(s2);
            s3.retainAll(s1);
            _xblockexpression_1 = s3;
          }
          return _xblockexpression_1;
        };
        mapping.merge(Integer.valueOf(coord1.getX()), Collections.<Integer>unmodifiableSet(CollectionLiterals.<Integer>newHashSet(Integer.valueOf(_x), Integer.valueOf(_y))), _function_1);
        int _x_1 = coord2.getX();
        int _y_1 = coord2.getY();
        final BiFunction<Set<Integer>, Set<Integer>, Set<Integer>> _function_2 = (Set<Integer> s1, Set<Integer> s2) -> {
          HashSet<Integer> _xblockexpression_1 = null;
          {
            final HashSet<Integer> s3 = new HashSet<Integer>(s2);
            s3.retainAll(s1);
        ...
        mapping.merge(Integer.valueOf(coord1.getY()), Collections.<Integer>unmodifiableSet(CollectionLiterals.<Integer>newHashSet(Integer.valueOf(_x_1), Integer.valueOf(_y_1))), _function_2);
      };
      dists1_dup.entrySet().forEach(_function);
      final Predicate<Integer> _function_1 = (Integer it) -> {
      ...
      final Consumer<Vector> _function_2 = (Vector it) -> {
        it.multiplyBy(rotation);
      };
      vectors2.forEach(_function_2);
      final Vector translation = v21.to(v11);
      final Consumer<Vector> _function_3 = (Vector it) -> {
        it.add(translation);
      };
  ...
  public static HashMap<Integer, Coordinate> distances(final List<Vector> vectors) {
    ...
    final Function2<HashMap<Integer, Coordinate>, Integer, HashMap<Integer, Coordinate>> _function = (HashMap<Integer, Coordinate> s, Integer i) -> {
      int _size_1 = vectors.size();
      final Function2<HashMap<Integer, Coordinate>, Integer, HashMap<Integer, Coordinate>> _function_1 = (HashMap<Integer, Coordinate> s1, Integer j) -> {
      ...
      return IterableExtensions.<Integer, HashMap<Integer, Coordinate>>fold(new ExclusiveRange(((i).intValue() + 1), _size_1, true), s, _function_1);
    };
