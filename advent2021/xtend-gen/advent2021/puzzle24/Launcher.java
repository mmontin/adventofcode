...
public class Launcher {
  ...
  private static final List<Pair<Integer, Integer>> input = IterableExtensions.<Integer, ArrayList<Pair<Integer, Integer>>>fold(new IntegerRange(0, 13), new ArrayList<Pair<Integer, Integer>>(), ((Function2<ArrayList<Pair<Integer, Integer>>, Integer, ArrayList<Pair<Integer, Integer>>>) (ArrayList<Pair<Integer, Integer>> l, Integer i) -> {
