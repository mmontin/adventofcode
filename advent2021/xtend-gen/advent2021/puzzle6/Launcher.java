...
public class Launcher {
  public static void main(final String[] args) {
    ...
    for (final Integer k : _doubleDotLessThan) {
      ...
      final Function2<HashMap<Integer, BigInteger>, Map.Entry<Integer, BigInteger>, HashMap<Integer, BigInteger>> _function_1 = new Function2<HashMap<Integer, BigInteger>, Map.Entry<Integer, BigInteger>, HashMap<Integer, BigInteger>>() {
        public HashMap<Integer, BigInteger> apply(final HashMap<Integer, BigInteger> output, final Map.Entry<Integer, BigInteger> e) {
          HashMap<Integer, BigInteger> _xblockexpression = null;
          {
            ...
            if (_equals) {
              ...
              output.merge(Integer.valueOf(_minus), e.getValue(), _function);
            }
    ...
    final Function2<BigInteger, BigInteger, BigInteger> _function_2 = new Function2<BigInteger, BigInteger, BigInteger>() {
