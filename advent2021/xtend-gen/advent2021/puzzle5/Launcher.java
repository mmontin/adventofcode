...
public class Launcher {
  public static void main(final String[] args) {
    ...
    final Function1<String, Segment> _function = (String s) -> {
      return new Segment(s);
    };
    final Consumer<Segment> _function_1 = (Segment s) -> {
    ...
    final Function2<Integer, Integer, Integer> _function_2 = (Integer v, Integer n) -> {
